...
def main():
    ...
    field_list={'simSeconds':'seconds', 
                'simInsts' : 'number of instructions',
                'system.ruby.network.avg_link_utilization' : 'count',
                'system.ruby.network.average_packet_latency' : 'count',
                'system.ruby.network.average_packet_network_latency' : 'count',
                'system.ruby.network.packets_injected::total' : 'packets',
                'system.ruby.network.packets_received::total' : 'packets'}
    ...
    try:
        ...
        with open("percentage.log", "w") as f: 
            for field, units in field_list.items():
                average_pf = 0 
                average_no_pf = 0
                difference = 0   
                ...
                msg = "{} : average_pf {}, average_no_pf {}, difference percent {}".format(field, average_pf, average_no_pf, difference)
                print(msg)
                msg += '\n'
                f.write(msg)
